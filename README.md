...
The repository contains domain entities and contracts for Warehouse business domain. The main domain interface is [ICompany](https://github.com/souly84/Warehouse.Core/blob/main/src/(Company)/ICompany.cs) which provides access to all business entities for the domain.
